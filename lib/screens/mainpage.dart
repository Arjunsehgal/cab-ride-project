...
class _MainPageState extends State<MainPage> with TickerProviderStateMixin {
  ...
  double searchSheetHeight = (Platform.isIOS) ? 300 : 340;
  ...
  void showRequestingSheet(){
    setState(() {
      ...
      requestingSheetHeight = (Platform.isAndroid) ? 200 : 220;
        ...
        children: <Widget>[
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller){
              ...
              setState(() {
                mapBottomPadding = (Platform.isAndroid) ? 340 : 300;
              });
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Text((tripDirectionDetails != null) ? '\R\s ${HelperMethods.estimateFares(tripDirectionDetails)}' : '', style: TextStyle(fontSize: 18, fontFamily: 'Brand-Bold'),),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(driverFullName, style: TextStyle(fontSize: 18),),
  ...
  resetApp(){
    ...
    setState(() {
      ...
      requestingSheetHeight = 0;
      tripSheetHeight = 0;
      searchSheetHeight = (Platform.isAndroid) ? 340 : 300;
      mapBottomPadding = (Platform.isAndroid) ? 340 : 300;
      drawerCanOpen = true;
